			...
			public function do_user_directory() {
				...
				foreach ( $users as $user ) { ?>
					<div class="directory_item">
						<h3><a href="index.php?q=view&uid=<?php echo $user->ID; ?>"><?php echo $user->user_nicename; ?></a></h3>
			...
			public function do_inbox($user_id) {
				...
				foreach ( $message_objects as $message ) {?>
					<div class="status_item">
						...
						<h3>From: <a href="index.php?q=view&uid=<?php echo $user->ID; ?>"><?php echo $user->user_nicename; ?></a></h3>
						<p>
							<h5>Subject:</h5><?php echo $message->message_subject; ?>
						</p>
						<p>
							<h5>Message Content:</h5><?php echo $message->message_content; ?>
						</p>
					</div>
				<?php
				}

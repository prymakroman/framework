<?php
	...
	if ( !class_exists('INSERT') ) {
		class INSERT {
			...
			public function add_status($user_id, $status_time, $status_content) {
				global $db;				
				$table = 's_status';				
				$query = "
			...
			public function send_message($message_time, $message_sender_id, $message_recipient_id, $message_subject, $message_content) {
				global $db;				
				$table = 's_messages';				
				$query = "
